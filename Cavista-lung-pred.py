...
def HomePage():
    ...
    st.markdown("<h1 style = ' text-align: center; font-family:montserrat'>Lung Cancer Prediction Model</h1>",unsafe_allow_html=True)
    st.markdown('<br>', unsafe_allow_html= True)
    st.markdown("<h6 style = 'margin: -15px;  text-align: center ; font-family:montserrat'>Lung cancer is one of the most common and deadliest forms of cancer worldwide. Early detection and intervention are crucial for improving patient outcomes. This project aims to develop a machine learning model that predicts the likelihood of an individual having lung cancer based on various health-related factors.</h6>",unsafe_allow_html=True)
    st.markdown('<br>', unsafe_allow_html= True)
    ...
    st.markdown("<h5 style='text-align: left; font-family:montserrat'>Fatigue</h3>", unsafe_allow_html=True)
    ...
    st.markdown("<h5 style='text-align: left; font-family:montserrat'>Chronic Disease</h3>", unsafe_allow_html=True)
    ...
    st.markdown("<h5 style='text-align: left; font-family:montserrat'> Shortness of Breath </h3>", unsafe_allow_html=True)
    ...
    st.markdown("<h5 style='text-align: left; font-family:montserrat'>Chest pain</h3>", unsafe_allow_html=True)
    ...
    st.markdown("<h5 style='text-align: left; font-family:montserrat'>Allergy</h3>", unsafe_allow_html=True)
    ...
    st.markdown("<h5 style='text-align: left; font-family:montserrat'>Gender</h3>", unsafe_allow_html=True)
    ...
    st.markdown("<h5 style='text-align: left; font-family:montserrat'>Yellow Fingers</h3>", unsafe_allow_html=True)
    ...
    st.markdown("<h5 style='text-align: left; font-family:montserrat'>Smoking</h3>", unsafe_allow_html=True)
    ...
    st.markdown("<h5 style='text-align: left; font-family:montserrat'>Alcohol Consuming</h3>", unsafe_allow_html=True)
    ...
    st.markdown("<h5 style='text-align: left; font-family:montserrat'>Coughing</h3>", unsafe_allow_html=True)
    ...
    st.markdown("<h5 style='text-align: left; font-family:montserrat'>Swallowing Difficulty</h3>", unsafe_allow_html=True)
    ...
    st.markdown("<h5 style='text-align: left; font-family:montserrat'>Anxiety</h3>", unsafe_allow_html=True)
...
if selected_page == "Modeling":
    ...
    st.markdown("<h8 style = ' text-align: LEFT; font-family:montserrat'>Lung Cancer Prediction MODEL BUILT BY The Orpheus Snipers at the Cavista Hackathon 2024</h8>",unsafe_allow_html=True)
